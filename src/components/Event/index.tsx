...
export default function Event() {
    ...
    return (
        <section className="container-box2 mt-betweenSectionMd xl:mt-betweenSection flex flex-col md:flex-row justify-between gap-14 md:gap-4" >
            <div>
                <motion.h2
                    ...
                    <div className="space-y-4 md:space-y-6">
                        ...
                        <motion.ul className="space-y-3 md:space-y-4" {...anim(stagger)}>
                            ...
                            <Li delay={0.6}>
                                ...
                                <p className="text-xs md:text-base font-roboto-slab -translate-x-2">Jalan Kapten Maulana Lubis No 6, <br /> Wisma Benteng Restaurant</p>
                            </Li>
                        </motion.ul>
                    </div>
                </div>
